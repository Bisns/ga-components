        ...
        <div class="row">
            ...
            <div class="overlaps">
                <div class="overlap-row">
                    ...
                    {/if}
                    {riskCounter === 0 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
                    ...
                    {/if}
                    {preCounter === 0 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
                    ...
                    {/if}
                    {hyperCounter < 2 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : hyperCounter === 2 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
                    ...
                    {/if}
                    {#if gender === 'F'}
                        {cvaFCounter === 0 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                    {:else}
                        {cvaCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : cvaCounter === 3 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                    {/if}
                </div>
                {#if gender === 'F'}
                    <div class="overlap-row">
                        ...
                        {/if}
                        {atheroCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : atheroCounter === 5 ? getTranslation(lang, 'SOME_OVERLAP_INSIGHTS') : getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS')}
                    </div>
                    <div class="overlap-row">
                        ...
                        {/if}
                        {coronaryCounter === 0 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : coronaryCounter === 1 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                    </div>
                {/if}
            </div>
        </div>
        <div class="row">
            ...
            <div class="overlaps">
                <div class="overlap-row">
                    ...
                    {/if}
                    {diabetesCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : diabetesCounter === 5 ? getTranslation(lang, 'SOME_OVERLAP_INSIGHTS') : getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
                    ...
                    {/if}
                    {dyslipidemiaCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : dyslipidemiaCounter === 3 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="overlaps">
                <div class="overlap-row">
                    ...
                    {/if}
                    {arthritisCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : arthritisCounter === 3 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
                    ...
                    {/if}
                    {colitisCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : colitisCounter === 3 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
                    ...
                    {/if}
                    {crohnCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : crohnCounter === 5 ? getTranslation(lang, 'SOME_OVERLAP_INSIGHTS') : getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS')}
                </div>
                <div class="overlap-row">
        ...
        <div class="row">
            ...
            <div class="overlaps">
                <div class="overlap-row">
                    ...
                    {/if}
                    {copdCounter === 0 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : copdCounter === 1 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                </div>
            </div>
        </div>
        {#if gender === 'F'}
            <div class="row">
                ...
                <div class="overlaps">
                    <div class="overlap-row">
                        ...
                        {/if}
                        {periCounter < 3 ? getTranslation(lang, 'NO_SIGNIFICANT_OVERLAP') : periCounter === 3 ? getTranslation(lang, 'MINOR_OVERLAP_INSIGHTS') : getTranslation(lang, 'SOME_OVERLAP_INSIGHTS')}
                    </div>
                </div>
            </div>
        {/if}
